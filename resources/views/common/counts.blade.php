...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">PROJECT COUNTS</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-6">
                    <div class="card card-primary" id="main">
                        <div class="card-header">
                            <div class="row">
                                <h3 class="card-title col-10">PROJECTS COUNT</h3>
...
<script type="text/javascript">
    function export_excel() {
        document.location.href="{!! route('fetch_countexport','count'); !!}";
    }
