...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">SENATORIAL ZONE VS PROJECT COUNT</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-6">
                    <div class="card card-primary" id="main">
                        <div class="card-header">
                            <div class="row">
                                <h3 class="card-title col-10">SENATORIAL ZONE VS PROJECT COUNT</h3>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function export_excel() {
            document.location.href="{!! route('fetch_countexport','zone'); !!}";
        }

        height_main=$("#main").height();
        console.log("height_main",height_main);
        $.ajax({
            url: "{{route('fetch_zonedata')}}",
            method: "post",
            data: {
                _token: "{{csrf_token()}}",
            },
            ...
            success: function(result) {
                ...
                chart_data=[['% percent', 'PROJECT COUNT', { role: 'style' }]];
